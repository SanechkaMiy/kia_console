...
public:
    ...
    ~ParseToDB();
    void sendDataIntoMSHIOR(uint16_t& num_bokz, int32_t& bshv, MSHIOR &st_mshior);
    void sendDataIntoSHTMI1(uint16_t& num_bokz, int32_t& bshv, SHTMI1 &st_shtmi1);
    void sendDataIntoSHTMI2(uint16_t& num_bokz, int32_t &bshv, SHTMI2 &st_shmti2);
    void sendDataIntoMPI(uint16_t& num_bokz, int32_t &bshv);
    void sendDataIntoDTMILOC(uint16_t& num_bokz, int32_t &bshv, DTMILoc_1 &dtmiLoc_1, DTMILoc_2 &dtmiLoc_2, DTMILoc_3 &dtmiLoc_3,
                             DTMILoc_4 &dtmiLoc_4, DTMILoc_5 &dtmiLoc_5, DTMILoc_6 &dtmiLoc_6,
                             DTMILoc_7 &dtmiLoc_7, DTMILoc_8 &dtmiLoc_8, DTMILoc_9 &dtmiLoc_9);
    void sendDataIntoDTMI(uint16_t& num_bokz, int32_t &bshv, DTMI_1& dtmi_1, DTMI_2& dtmi_2, DTMI_3 &dtmi_3, DTMI_4 &dtmi_4,
