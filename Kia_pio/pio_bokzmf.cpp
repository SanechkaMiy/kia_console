...
void Pio_bokzmf::decrypt_shtmi1(array<uint16_t, constants::packetSize> dataWord)
{
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("1", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Номер подмассива");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("2,3", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("4", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Время привязки информации");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("5", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("6", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("7", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Заводской номер");
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_data.push_back(QString::number(m_kia_mko_struct->st_shtmi1_mf.T));

    m_kia_mko_struct->st_shtmi1_mf.POST = shmti1_raw.POST;
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("8", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("9, 10", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Фокусное расстояние");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("11, 12", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("13, 14", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("15", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("16", m_kia_settings->m_format_for_desc->shift_for_numbers)
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("17", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "СКО сигнала");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("19", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Резерв");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("20", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Резерв");
    ...
    m_kia_mko_struct->st_shtmi1_mf.shtmi1_list_name.push_back(format_qstring("32", m_kia_settings->m_format_for_desc->shift_for_numbers)
                                      + "Номер версии ПО");
