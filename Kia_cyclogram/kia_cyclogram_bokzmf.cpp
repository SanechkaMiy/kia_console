...
uint16_t Kia_cyclogram_bokzmf::start_no(uint16_t &num_bokz)
{

}

uint16_t Kia_cyclogram_bokzmf::start_to(uint16_t &num_bokz)
{

}

uint16_t Kia_cyclogram_bokzmf::start_loc(uint16_t &num_bokz, uint16_t count_do_loc)
{
